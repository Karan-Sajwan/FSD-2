...
![Build Backend](./Screenshots/1.png)

**Building frontend image:**

![Build Frontend](./Screenshots/2.png)

**Both images listed:**

![Docker Images](./Screenshots/3.png)
...
![Network and MySQL](./Screenshots/4.png)

![MySQL Pull](./Screenshots/5.png)

**Starting backend and frontend containers:**

![Run Containers](./Screenshots/6.png)

**All 3 containers running:**

![Docker PS](./Screenshots/7.png)

**Application running in browser (Register successful):**

![App Running](./Screenshots/8.png)
...
![Compose Build](./Screenshots/9.png)

**All services started by Compose:**

![Compose Up](./Screenshots/10.png)

**Docker Compose logs — MySQL and Flask backend running:**

![Compose Logs](./Screenshots/11.png)
...
![Docker Hub Token](./Screenshots/12.png)

**Add secrets to GitHub repository** — `DOCKER_USERNAME` and `DOCKER_PASSWORD`:

![GitHub Secrets](./Screenshots/13.png)

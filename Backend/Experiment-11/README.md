...
def get_account_details(user_id):
    ...
    try:
        response = requests.get(
            f"https://https://two3bis70054-experiment-11-customer.onrender.com/orders/user/{user_id}",
            timeout=3
        )
...
- Customer Service: https://two3bis70054-experiment-11-customer.onrender.com
- Order Service: https://two3bis70054-experiment-11-order.onrender.com
...
![Customer Service](c:\Users\Karam Sajwan\OneDrive\Pictures\Screenshots 1\Screenshot 2026-03-30 103248.png)
